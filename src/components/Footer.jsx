    ...
    <Container>
      <Left>
        ...
        <SocialContainer>
          <SocialIcon
          color="3B5999"
          href="https://www.facebook.com/TieuHocLeLoiVungTau"
          target="_blank">
            <Facebook />
          </SocialIcon>
      ...
      <Right>
        <Title>Liên hệ</Title>
        <ContactItem>
          <Room style={{marginRight:"10px"}}/> 276 Lê lợi, phường 7, TP. Vũng Tàu, BR-VT
        </ContactItem>
        <ContactItem>
          <Phone style={{marginRight:"10px"}}/> 0254 383 9310
        </ContactItem>
        {/* <ContactItem>
